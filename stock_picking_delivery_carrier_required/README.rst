...
1. I validate a picking (operation type is not delivery) without encountering an error message, 
...
2. I note that at the delivery level, the two fields `Carrier` and `Tracking Reference` are mandatory:
