...
Configuration
-------------
1. On partner form, set a Delivery Contact (Sales & Purchase tab)
2. On delivery carrier form, enable "Send Delivery Notification" (Notifications tab)
3. Select an email template for the notification
4. The system will automatically send emails to the configured contact when deliveries are done
    """,
    'author': 'Numigi',
